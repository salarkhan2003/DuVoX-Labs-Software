...
const products = [
  {
    ...
    description: 'A powerful yet accessible AI system designed for young parents. Advanced cry detection, baby rash monitoring, and vital health tracking that works offline. Designed specifically for Rural and Urban India, bringing peace of mind to millions of families.',
    icon: Baby,
    features: [
  ...
  },
  {
    ...
    description: 'An intelligent co-pilot that assists drivers with real-time safety alerts, EV diagnostics, and predictive driving feedback. Advanced accident risk detection with seamless integration for EV and autonomous vehicles.',
    icon: Car,
    features: [
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Revolutionary AI solutions designed to enhance human life through intelligent automation and insights.
          </p>
        </motion.div>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                <div className="mb-4">
                  <span className={`inline-block px-3 py-1 text-sm font-medium rounded-full bg-gradient-to-r ${product.gradient} text-white`}>
                    {product.status}
                  </span>
                </div>
                ...
                <h4 className={`text-xl mb-6 bg-gradient-to-r ${product.gradient} bg-clip-text text-transparent font-semibold`}>
                  {product.subtitle}
                </h4>
              ...
              <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                <Card className={`p-8 bg-gradient-to-br ${product.bgGradient} border-0 shadow-2xl`}>
