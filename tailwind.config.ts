  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        // Custom typography scales for the futuristic design
        ...
        'subheading': ['clamp(1.25rem, 3vw, 1.75rem)', { lineHeight: '1.4' }],
      ...
      fontFeatureSettings: {
        ...
        'numbers': '"kern" 1, "liga" 1, "calt" 1, "tnum" 1',
        'small-caps': '"kern" 1, "liga" 1, "calt" 1, "smcp" 1',
      },
      keyframes: {
        fadeIn: {
          from: { opacity: '0' },
